...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:8080/EcomProj/Product/AddProduct.jsp">About Us</a>
            </li>
        </ul>
        ...
        <c:choose>
            ...
            <c:when test="${not empty userObject}">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="#"><i>Profile</i></a>
            ...
            <c:otherwise>
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/EcomProj/User/Registration.jsp">Registration</a>
                    </li>
                </ul>
            </c:otherwise>
